...
@patch("os.makedirs")
@patch("os.path.exists")
def test_ensure_cache_dir_already_exists(
    exists: MagicMock, makedirs: MagicMock, chmod: MagicMock
):
...
def test_read_aws_cache(
    ensure_cache_dir: MagicMock,
    is_file: MagicMock,
    json_load: MagicMock,
    open: MagicMock,
):
...
@patch("os.path.isfile")
@patch.object(cache, "ensure_cache_dir")
def test_read_aws_cache_no_expiration(
    ensure_cache_dir: MagicMock,
    is_file: MagicMock,
    json_load: MagicMock,
    open: MagicMock,
...
@patch("os.path.isfile")
@patch.object(cache, "ensure_cache_dir")
def test_read_aws_cache_no_file(
    ensure_cache_dir: MagicMock,
    is_file: MagicMock,
    json_load: MagicMock,
    open: MagicMock,
...
@patch("os.path.isfile")
@patch.object(cache, "ensure_cache_dir")
def test_read_aws_cache_catch_exception(
    ensure_cache_dir: MagicMock,
    is_file: MagicMock,
    json_load: MagicMock,
    open: MagicMock,
...
@patch("os.path.isfile")
@patch.object(cache, "ensure_cache_dir")
def test_write_aws_cache_catch_exception(
    ensure_cache_dir: MagicMock,
    is_file: MagicMock,
    chmod: MagicMock,
    json_dump: MagicMock,
